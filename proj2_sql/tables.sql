create or replace type image as object (
	...
	src varchar2(30),
	map member function get_idno return integer,
	member function get_src return varchar2,
	member function show_alt return varchar2  
) not final;

/

create or replace type body image as
	map member function get_idno return integer is
	begin
		return idno;
	end;

	member function get_src return varchar2 is
	begin
		return src;
	end;

	member function show_alt return varchar2 is
	begin
		return alt_text;
	end;
end;
...
create or replace type body profile_image as
	member function get_username return varchar2 is
	begin
		return username;
	end;	

	member function get_thumbnail return varchar2 is
	begin
		return thumbnail_src;
	end;		

	overriding member function show_alt return varchar2 is
	begin
		return 'profile image for ' || username || ', ' || alt_text;
	end;
end;
/
...
-- 	foreign key(p_id) references Preferences on delete cascade
-- );
>>>>>>> ca03a1e4087cb927854ee8771c3ab18708a1fd6f
